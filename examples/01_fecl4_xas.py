...
n_mo, n_elec, n_pcore = m_fecl4.norb, m_fecl4.n_elec, m_fecl4.n_pcore
if 'mrci' in method:
    orb_space = (m_fecl4.n_core, m_fecl4.n_inactive, m_fecl4.n_external, m_fecl4.n_active) 
    print("orb space = ", orb_space)
    occs_igs = None
else:
    orb_space = None 
    occs_igs = None
...
driver.initialize_system(n_sites=n_gmo, n_elec=na+nb, spin=twos, orb_sym=orb_sym)
...
mps_gs = driver.get_random_restricted_mps(tag="GS", bond_dim=bond_dims_gs[0],
                                          casci_ncore=n_gpcore, n_hole=0)
